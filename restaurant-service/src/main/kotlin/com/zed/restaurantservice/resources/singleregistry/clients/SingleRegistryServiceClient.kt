...
interface SingleRegistryServiceClient {

    @GetMapping("/person/{personId}")
    fun findByPersonId(@PathVariable personId: String?, @RequestHeader("Authorization") accessToken: String): ResponseEntity<Legal>
}
